...
@section('content')
    <section class="container-fluid d-flex flex-column align-items-center">
        ...
        <form class="container-fluid" action="{{ route('Location.store') }}" method="POST" enctype="multipart/form-data" id="form-location">
            @csrf
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <div class="row mb-2 mr-2 d-flex justify-content-around">
                        <a style="color:#0d6efd; text-decoration:underline; cursor:pointer;" role="button" onclick="LocataireModal()" data-toggle="modal" data-target=".modal-locataire-form">Modifier Locataire</a>
                    </div>
                    <div class="row mb-2">
                        <label class="col-sm-3 d-flex align-items-center"><em><b>Nom et prenom</b></em></label>
                        <div class="col-sm-9">
                            <input type="hidden" name="client_id" value="{{ $client->id }}" id="client_id_show">
                            <input type="hidden" name="reservation_id" value="{{ $reservation_id }}">
                            <input type="text" class="form-control" name="nom_complet" id="client_nom_complet_show" placeholder="Nom et prenom"
                                value="{{ $client->nom_complet }}" readonly>
                        </div>
                    </div>
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-9">
                            <input type="date" class="form-control" name="date_naissance"
                                value="{{ $client->date_naissance }}" id="client_date_naissance_show" readonly>
                        </div>
                    </div>
                    <div class="row mb-2">
                        <label class="col-sm-3 d-flex align-items-center"><em><b>Lieu de naissance</b></em></label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="Lieu_naissance" placeholder="Lieu"
                                value="{{ $client->lieu_naissance }}" id="client_lieu_naissance_show" readonly>
                        </div>
                    </div>
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-3">
                            <input type="text" class="form-control" name="nationalite" placeholder="Nationalite"
                                value="{{ $client->nationalite }}" id="client_nationalite_show" readonly>
                        </div>
                        <label class="col-sm-2 d-flex align-items-center"><em><b>Telephone</b></em></label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="tel" placeholder="Ex: 061321311"
                                value="{{ $client->tel }}" id="client_tel_show" readonly>
                        </div>
                    </div>
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="adresse" placeholder="Adresse"
                                value="{{ $client->adresse }}" id="client_adresse_show" readonly>
                        </div>
                    </div>
                    <div class="row mb-2">
                        <label class="col-sm-3 d-flex align-items-center"><em><b>C.I.N</b></em></label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="num_cin" placeholder="Numero CIN"
                                value="{{ $client->num_cin }}" id="client_num_cin_show" readonly>
                        </div>
                    </div>
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-3">
                            <input type="date" class="form-control" name="cin_delivre"
                                value="{{ $client->cin_delivre }}" id="client_cin_delivre_show" readonly>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <input type="date" class="form-control" name="cin_validite"
                                value="{{ $client->cin_validite }}" id="client_cin_validite_show" readonly>
                        </div>
                    </div>
                    <div class="row mb-2">
                        <label class="col-sm-3 d-flex align-items-center"><em><b>Permis</b></em></label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="num_permis" placeholder="Numero Permis"
                                value="{{ $client->num_permis }}" id="client_num_permis_show" readonly>
                        </div>
                    </div>
                    <div class="row mb-2">
                        <label class="col-sm-3 d-flex align-items-center"><em><b>Delivre le</b></em></label>
                        <div class="col-sm-3">
                            <input type="date" class="form-control" name="permis_delivre"
                                value="{{ $client->permis_delivre }}" id="client_permis_delivre_show" readonly>
                        </div>
                        <label class="col-sm-2 d-flex align-items-center"><em><b>Valable jusqu'a</b></em></label>
                        <div class="col-sm-4">
                            <input type="date" class="form-control" name="permis_validite"
                                value="{{ $client->permis_validite }}" id="client_permis_validite_show" readonly>
                        </div>
                    </div>
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="num_passeport"
                                placeholder="Numero Passeport" value="{{ $client->num_passeport }}" id="client_num_passeport_show" readonly>
                        </div>
                    </div>
                    <div class="row mb-2">
                        <label class="col-sm-3 d-flex align-items-center"><em><b>Delivre le</b></em></label>
                        <div class="col-sm-3">
                            <input type="date" class="form-control" name="passeport_delivre"
                                value="{{ $client->passeport_delivre }}" id="client_passeport_delivre_show" readonly>
                        </div>
                        <label class="col-sm-2 d-flex align-items-center"><em><b>Valable jusqu'a</b></em></label>
                        <div class="col-sm-4">
                            <input type="date" class="form-control" name="passeport_validite"
                                value="{{ $client->passeport_validite }}" id="client_passeport_validite_show" readonly>
                        </div>
                    </div>
                    <div class="row mb-2">
                        <label class="col-sm-3 d-flex align-items-center"><em><b>Date d'entree au Maroc</b></em></label>
                        <div class="col-sm-9">
                            <input type="date" class="form-control" name="client_date_maroc" value="{{ date("Y-m-d") }}" required>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="row mb-2 mr-2 d-flex justify-content-end">
                        <a style="color:#0d6efd; text-decoration:underline; cursor:pointer;" onclick="param('vehicule-update')" role="button" data-toggle="modal" data-target=".modal-table-vehicule">Changer Vehicule</a>
                    </div>
                    <div class="row mb-2">
                        <label class="col-sm-3 d-flex align-items-center"><em><b>Marque</b></em></label>
                        <div class="col-sm-3">
                            <input type="hidden" name="vehicule_id" value="{{ $vehicule->id }}" id="vehicule_id">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-3">
                            <input type="datetime-local" class="form-control" name="date_depart" id="date_depart" onchange="CalculDate(); CalculTotal();"
                                value="{{ $reservation->date_debut }}" required>
                        </div>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-3">
                            <input type="datetime-local" class="form-control" name="date_retour" id="date_retour" onchange="CalculDate(); CalculTotal();"
                                value="{{ $reservation->date_fin }}" required>
                        </div>
                        ...
                        <div class="row d-flex flex-column align-items-center justify-content-center mb-3 mt-5">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <a class="btn btn-primary text-color mt-4 mr-4" data-toggle="modal"
                                    data-target=".bd-example-modal-lg" role="button">Ajouter</a>
                                <a class="btn btn-success mt-4 ml-4" role="button" data-toggle="modal" data-target=".modal-table-show">Choisir</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row mt-4 mb-5">
                <div class="col-sm-6">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-3">
                            <input class="form-control" type="number" name="acompte" step="any" id="acompte" @if ( !is_null($reservation->avance) ) value="{{ $reservation->avance }}" @else value="0" @endif onkeyup="CalculRestePayer()" required>
                        </div>
                    </div>
                    <div class="row mb-2">
            ...
            <div class="row mt-4 mb-5">
                <div class="col-sm-6" id="conducteur_show" style="display: none">
                    ...
                    <div class="row mb-2 mr-2 d-flex justify-content-around">
                        <a style="color:#0d6efd; text-decoration:underline; cursor:pointer;" role="button" onclick="ConducteurModal()" data-toggle="modal" data-target=".bd-example-modal-lg">Modifier Conducteur</a>
                    </div>
                    <div class="row mb-2">
                        <label class="col-sm-3 d-flex align-items-center"><em><b>Nom et prenom</b></em></label>
                        <div class="col-sm-9">
                    ...
                    <div class="row mb-2">
                        <label class="col-sm-3 d-flex align-items-center"><em><b>Date d'entree au Maroc</b></em></label>
                        <div class="col-sm-9">
                            <input type="date" class="form-control" name="conducteur_date_maroc" id="conducteur_date_maroc_show" >
                        </div>
                    </div>
                </div>
            </div>
            <div class="row mt-4 mb-5">
                ...
                <div class="col d-flex justify-content-center">
                    <button type="submit" id="submit-location-form" class="btn btn-primary">Valider</button>
                </div>
            </div>
        </form>
    </section>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myLargeModalLabel">Formulaire 2<sup>eme</sup> Conducteur</h4>
                        ...
                        <div class="col-sm-12">
                            <form method="POST">
                                <div class="row mb-2">
                                    <label class="col-sm-3 d-flex align-items-center"><em><b>Nom et prenom</b></em></label>
                                    <div class="col-sm-9">
                                        <input type="hidden" name="conducteur_id" id="conducteur_id_update">
                                        <input type="text" class="form-control" name="nom_complet"
                                ...
                                @foreach ($conducteurs as $conducteur)
                                    <tr>
                                        ...
                                        <td class="actions d-flex justify-content-end">
                                            ...
                                            <a data-dismiss="modal" onclick="GetConducteur({{ $conducteur->id }})" class="btn btn-outline-info btn-sm mr-2"><span class="material-symbols-outlined">edit</span></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
...
@push('scripts')
    ...
    <script>
        ...
        function LocataireModal(){
            document.getElementById('client_id_update').value = document.getElementById('client_id_show').value;
            document.getElementById('client_nom_complet_update').value = document.getElementById('client_nom_complet_show').value;
            document.getElementById('client_date_naissance_update').value = document.getElementById('client_date_naissance_show').value;
            document.getElementById('client_lieu_naissance_update').value = document.getElementById('client_lieu_naissance_show').value;
            document.getElementById('client_nationalite_update').value = document.getElementById('client_nationalite_show').value;
            document.getElementById('client_tel_update').value = document.getElementById('client_tel_show').value;
            document.getElementById('client_adresse_update').value = document.getElementById('client_adresse_show').value;
            document.getElementById('client_num_cin_update').value = document.getElementById('client_num_cin_show').value;
            document.getElementById('client_cin_delivre_update').value = document.getElementById('client_cin_delivre_show').value;
            document.getElementById('client_cin_validite_update').value = document.getElementById('client_cin_validite_show').value;
            document.getElementById('client_num_permis_update').value = document.getElementById('client_num_permis_show').value;
            document.getElementById('client_permis_delivre_update').value = document.getElementById('client_permis_delivre_show').value;
            document.getElementById('client_permis_validite_update').value = document.getElementById('client_permis_validite_show').value;
            document.getElementById('client_num_passeport_update').value = document.getElementById('client_num_passeport_show').value;
            document.getElementById('client_passeport_delivre_update').value = document.getElementById('client_passeport_delivre_show').value;
            document.getElementById('client_passeport_validite_update').value = document.getElementById('client_passeport_validite_show').value;
        }
      ...
      <div class="form-group row w-100">
        ...
        function GetConducteur(id){
            $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $("#conducteur_date_maroc_show").prop('required', true);
        ...
        function ConducteurModal(){
            document.getElementById('conducteur_id_update').value = document.getElementById('conducteur_id').value;
            document.getElementById('conducteur_nom_complet').value = document.getElementById('conducteur_nom_complet_show').value;
            document.getElementById('conducteur_date_naissance').value = document.getElementById('conducteur_date_naissance_show').value;
            document.getElementById('conducteur_lieu_naissance').value = document.getElementById('conducteur_lieu_naissance_show').value;
            document.getElementById('conducteur_nationalite').value = document.getElementById('conducteur_nationalite_show').value;
            document.getElementById('conducteur_tel').value = document.getElementById('conducteur_tel_show').value;
            document.getElementById('conducteur_adresse').value = document.getElementById('conducteur_adresse_show').value;
            document.getElementById('conducteur_num_cin').value = document.getElementById('conducteur_num_cin_show').value;
            document.getElementById('conducteur_cin_delivre').value = document.getElementById('conducteur_cin_delivre_show').value;
            document.getElementById('conducteur_cin_validite').value = document.getElementById('conducteur_cin_validite_show').value;
            document.getElementById('conducteur_num_permis').value = document.getElementById('conducteur_num_permis_show').value;
            document.getElementById('conducteur_permis_delivre').value = document.getElementById('conducteur_permis_delivre_show').value;
            document.getElementById('conducteur_permis_validite').value = document.getElementById('conducteur_permis_validite_show').value;
            document.getElementById('conducteur_num_passeport').value = document.getElementById('conducteur_num_passeport_show').value;
            document.getElementById('conducteur_passeport_delivre').value = document.getElementById('conducteur_passeport_delivre_show').value;
            document.getElementById('conducteur_passeport_validite').value = document.getElementById('conducteur_passeport_validite_show').value;
        }
        ...
        $("#conducteur-store").click(function(e) {
            ...
            //this is to know if this function is used to update or to create a conducteur
            if (id != ''){
                url = "/Conducteur/update/"+id;
                method = "PATCH";
            }else{
            ...
            var facturationValue = $('input[name=facturation_unite]:checked').val();
                ...
                if(facturationValue == "{{ \App\Enums\Unite::Km->value }}"){
                    $('.box-facturation').html(
                        ...
                        <div class="col-sm-2">\
                            <input class="form-control" type="number" name="nbr" step="any" id="nbr" onchange="CalculTotal()" required>\
                        </div>\
                        <label class="col-sm-2 d-flex align-items-center"><em><b>Prix/km</b></em></label>\
                        <div class="col-sm-2">\
                            <input class="form-control" type="number" name="prix" step="any" @if( $vehicule->unite == \App\Enums\Unite::Km->value) value="{{ $vehicule->tarif }}" @endif id="prix" onchange="CalculTotal()" required>\
                        </div>\
                        <label class="col-sm-1 d-flex align-items-center"><em><b>Total</b></em></label>\
                        <div class="col-sm-2">\
                            <input class="form-control" type="number" name="total_km" value="{{ $reservation->tarif }}" step="any" id="total" required>\
                        </div>'
                        );
                }else if(facturationValue == "{{ \App\Enums\Unite::Jour->value }}"){
                    $('.box-facturation').html(
                        ...
                        <div class="col-sm-2">\
                            <input class="form-control" type="number" name="prix" step="any" @if( $vehicule->unite == \App\Enums\Unite::Jour->value) value="{{ $vehicule->tarif }}" @endif id="prix" onchange="CalculTotal()" required>\
                        </div>\
                        <label class="col-sm-1 d-flex align-items-center"><em><b>Total</b></em></label>\
                        <div class="col-sm-2">\
                            <input class="form-control" type="number" name="total_jr" value="{{ $reservation->tarif }}" step="any" id="total" required>\
                        </div>'
                        );
                        CalculDate();
                    ...
                    $('.box-facturation').html(
                        ...
                        <div class="col-sm-2">\
                            <input class="form-control" type="text" name="nbr" step="any" id="nbr" onchange="CalculTotal()" required>\
                        </div>\
                        <label class="col-sm-2 d-flex align-items-center"><em><b>Prix/heure</b></em></label>\
                        <div class="col-sm-2">\
                            <input class="form-control" type="number" name="prix" step="any" @if( $vehicule->unite == \App\Enums\Unite::Heure->value) value="{{ $vehicule->tarif }}" @endif id="prix" onchange="CalculTotal()" required>\
                        </div>\
                        <label class="col-sm-1 d-flex align-items-center"><em><b>Total</b></em></label>\
                        <div class="col-sm-2">\
                            <input class="form-control" type="number" name="total_heures" value="{{ $reservation->tarif }}" step="any" id="total" required>\
                        </div>'
                        );
                        CalculDate();
